...
filename = ['Acrobat_w_rotation' num2str(gamma) '.gif'];
...
for i = 1:1:length(t_new)
    ...
    p_1 = P_1(m1,l1,th1_st,dth1_st,m2,l2,th2_st,dth2_st,m3,l3,th3_st,dth3_st,u_th1,u_th2,g);
    p_2 = P_2(m1,l1,th1_st,dth1_st,m2,l2,th2_st,dth2_st,m3,l3,th3_st,dth3_st,u_th1,u_th2,g);
    p_3 = P_3(m1,l1,th1_st,dth1_st,m2,l2,th2_st,dth2_st,m3,l3,th3_st,dth3_st,u_th1,u_th2,g);
